 ...
 *
 * <p>This mirrors the issuer's {@code TokenMinter} rather than calling it, because one Micronaut
 * application cannot live on another's classpath. The claims are the identity model of FR-013, so a
 * token minted here is indistinguishable from one the issuer would produce.
 */
