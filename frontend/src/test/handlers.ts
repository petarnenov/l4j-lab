...
export function nodes(failAtSummarize = false) {
  const base = [
    {
      position: 1,
      nodeName: 'PrepareRequest',
      succeeded: true,
      failureReason: null,
      inputPayload: { companyId: 'northwind-lighting' },
      outputPayload: { companyId: 'northwind-lighting', period: '2025-Q2' },
      startedAt: '2026-09-12T10:00:00Z',
      durationMs: 1,
      modelRequestText: null,
    ...
    {
      position: 2,
      nodeName: 'RetrieveRecords',
      succeeded: true,
      failureReason: null,
      inputPayload: { companyId: 'northwind-lighting' },
      outputPayload: { current: { revenue: '4200' } },
    ...
    {
      position: 3,
      nodeName: 'ComputeIndicators',
      succeeded: true,
      failureReason: null,
      inputPayload: { current: { revenue: '4200' } },
      outputPayload: { indicators },
  ...
  return [
    ...
    failAtSummarize
      ? {
          ...
          inputPayload: { indicators },
          outputPayload: null,
          startedAt: '2026-09-12T10:00:03Z',
          durationMs: 45000,
          modelRequestText: 'Indicators:\n- revenueGrowth = 0.2500',
          modelResponseText: null,
          inputTokens: null,
          outputTokens: null,
        }
      : {
          ...
          failureReason: null,
          inputPayload: { indicators },
          outputPayload: { text: 'Revenue grew 0.2500.' },
          startedAt: '2026-09-12T10:00:03Z',
          durationMs: 900,
          modelRequestText: 'Indicators:\n- revenueGrowth = 0.2500',
          modelResponseText: 'Revenue grew 0.2500.',
          inputTokens: 120,
          outputTokens: 80,
        },
  ]
...
export const server = setupServer(
  ...
  http.post('/api/runs', () =>
    HttpResponse.json(
      { runId: '11111111-1111-1111-1111-111111111111', status: 'PENDING' },
      { status: 202 },
    ),
  ),
      ...
      runs: [
        {
          ...
          period: '2025-Q2',
          status: 'SUCCEEDED',
          summaryPreview: 'Revenue grew 0.2500',
          startedAt: '2026-09-12T10:00:00Z',
          endedAt: '2026-09-12T10:00:04Z',
        },
        {
